...
\caption{The workflow specification (on the left) TODO: Add
  description of the workflow. The workflow
...
\begin{center}
  ...
  \caption{Workflow evolution provenance. TODO: Add exploration
    description. Complete provenance of the exploration process is
...
VisMashups \cite{Santos09}, a system for simplifying the creation,
maintenance and use of customized workflows, is also
integrated into CrowdLabs. It enables users to modify parameters and
...
One of the goals of the VisTrails system and CrowdLabs is to
...
results for publication. By supporting the publication on wikis, other
Web sites, or scientific documents, this framework allows users to create
...
workflow with the parameters used to generate them.
