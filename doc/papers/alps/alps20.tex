...
\author[eth]{J. Gukelberger} \ead{gukelberger@phys.ethz.ch}
\author[columbia]{E. Gull} \ead{gull@phys.columbia.edu}
\author[bonn]{S.~Guertler} \ead{guertler@th.physik.uni-bonn.de}
\author[eth]{A. Hehn} \ead{hehn@phys.ethz.ch}
\author[jaea,crest]{R.~Igarashi} \ead{rigarash@hosi.phys.s.u-tokyo.ac.jp}
\author[utah]{D. Koop} \ead{dakoop@cs.utah.edu}
\author[eth]{P.N. Ma} \ead{pingnang@phys.ethz.ch}
\author[tokyo]{H. Matsuo} \ead{halm@looper.t.u-tokyo.ac.jp}
...
\address[jaea]{Center for Computational Science \& e-Systems, Japan Atomic Energy Agency, 110-0015 Tokyo, Japan}
\address[crest]{Core Research for Evolutional Science and Technology, Japan Science and Technology Agency, 332-0012 Kawaguchi, Japan}
\address[harvard]{} 
