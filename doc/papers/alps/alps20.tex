...
Monte Carlo (QMC) techniques \cite{Evertz03}, as well as the  advent of a new class of variational approaches based on 
tensor network states \cite{vidal1,vidal2}. 
Some of the algorithmic refinements have led to computational speedups of many order of magnitudes, such as 
the development of non-local update schemes \cite{Swendsen87} in QMC methods \cite{Prokofev98A,Evertz03,Todo01,looper,Sylyuasen,Alet2005}, 
the sampling of extended ensembles \cite{WangLandau01a,WangLandau01b,Troyer03,Trebst04,Katzgraber06,Wessel07},
...
The ALPS web page~\cite{alps} contains an extensive list of tutorials, explaining the use of the various application codes and evaluation tools. We also present tutorials that show how to use the ALPS libraries in the user's own code. 
