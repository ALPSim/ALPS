...
This  solution is especially useful for Linux users that want to try ALPS, or for summer schools or lectures.
...
\subsection{Updated applications from previous versions}
...
We should discuss how VisTrails caches results, with the advantage that only those part of a workflow that have been changed have to be reexecuted - a bug advantage over scripts. Also, we should mention Dave's paper on strong links and persistent storage.
...
ALPS 2.0 provides package of modules for VisTrails, for the preparation of input files, the execution of simulations, and data analysis and plotting.
