...
input_file = pyalps.writeInputFiles('mc08c',parms)
pyalps.runApplication('loop',input_file)

data = pyalps.loadMeasurements(pyalps.getResultFiles(pattern='mc08c.task*.out.h5'),['Binder Ratio of Staggered Magnetization','Stiffness'])
