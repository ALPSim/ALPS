...
# data = pyalps.loadMeasurements(pyalps.getResultFiles(prefix='mc07b'),['|Magnetization|', 'Connected Susceptibility', 'Specific Heat', 'Binder Cumulant', 'Binder Cumulant U2'])
...
# plt.title(r'2D Ising model, $lpha$ is %.4s' % alpha_nu)
# plt.show()
# 
