...
IF(HAVE_MKL)
  ...
  if(NOT _libraries_work)
    ...
    set(LAPACK_DEFINITIONS "-DBOOST_NUMERIC_BINDINGS_BLAS_CBLAS -DBOOST_NUMERIC_BINDINGS_BLAS_MKL")
...
IF(NOT LAPACK_LIBRARY_INIT)
  IF(${CMAKE_SYSTEM_NAME} MATCHES "Darwin")
    ...
    SET(LAPACK_LIBRARY_INIT 1)
    SET(LAPACK_DEFINITIONS "-DBOOST_NUMERIC_BINDINGS_BLAS_CBLAS -DBOOST_NUMERIC_BINDINGS_BLAS_VECLIB -DBOOST_NUMERIC_BINDINGS_LAPACK_VECLIB")
    ADD_DEFINITIONS(${LAPACK_DEFINITIONS})
    SET(MAC_VECLIB 1 CACHE BOOL "use Mac Framework")
    SET(ALPS_HAVE_VECLIB 1)
    SET(LAPACK_LIBRARY "")
