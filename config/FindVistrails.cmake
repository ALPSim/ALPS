...
if(WIN32 AND NOT UNIX)
  ...
  set(VISTRAILS_PYTHON_EXTENSION_DIR "${VISTRAILS_APP_NAME}/${VISTRAILS_PYTHON_DIR}/Lib/site-packages" )
  ...
  set(VISTRAILS_PYTHON_INTERPRETER "${VISTRAILS_APP_NAME}/${VISTRAILS_PYTHON_DIR}/python.exe")
  ...
  if(APPLE)	
    ...
    if(EXISTS "${VISTRAILS_APP_DIR}/${VISTRAILS_APP_NAME}/Contents/Resources/lib/python2.7/packages")
      set(VISTRAILS_PACKAGE_DIR "${VISTRAILS_APP_NAME}/Contents/Resources/lib/python2.7/packages")
      set(VISTRAILS_PYTHON_EXTENSION_DIR "${VISTRAILS_APP_NAME}/Contents/Resources/lib/python2.7")
    else(EXISTS "${VISTRAILS_APP_DIR}/${VISTRAILS_APP_NAME}/Contents/Resources/lib/python2.7/packages")
      set(VISTRAILS_PACKAGE_DIR "${VISTRAILS_APP_NAME}/Contents/Resources/lib/python2.6/packages")
      set(VISTRAILS_PYTHON_EXTENSION_DIR "${VISTRAILS_APP_NAME}/Contents/Resources/lib/python2.6")
    endif(EXISTS "${VISTRAILS_APP_DIR}/${VISTRAILS_APP_NAME}/Contents/Resources/lib/python2.7/packages")
