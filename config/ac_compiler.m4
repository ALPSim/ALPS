AC_DEFUN([AC_COMPILER],
  ...
  case "$COMPILER" in
    gnu)
      ...
      try_CXXFLAGS_OPT="-pthread -w -ftemplate-depth-120 -O3"
      try_CXXFLAGS_DEBUG="-pthread -W -Wall -Wno-sign-compare -ftemplate-depth-120 -g -O0"
    ...
    gnu-3.3)
      try_CFLAGS_OPT="-pthread -w -O3"
      try_CFLAGS_DEBUG="-pthread -W -Wall -Wno-sign-compare -g -O0"
      try_CXXFLAGS_OPT="-fabi-version=0 -pthread -w -ftemplate-depth-120 -O3"
      try_CXXFLAGS_DEBUG="-fabi-version=0 -pthread -W -Wall -Wno-sign-compare -ftemplate-depth-120 -g -O0"
      try_CXXFLAGS_EH="-fexceptions"
      try_CXXFLAGS_NOEH="-fno-exceptions"
      ;;
    kai)
    ...
    macos-3.3)
      ...
      try_CXXFLAGS_OPT="-fabi-version=0 -w -ftemplate-depth-120 -O3"
      try_CXXFLAGS_DEBUG="-fabi-version=0 -W -Wall -Wno-sign-compare -Wno-long-double -ftemplate-depth-120 -g -O0"
      try_CXXFLAGS_EH="-fexceptions"
      try_CXXFLAGS_NOEH="-fno-exceptions"
      ;;
    macos)
      try_CFLAGS_OPT="-w -O3"
      try_CFLAGS_DEBUG="-W -Wall -Wno-sign-compare -Wno-long-double -g -O0"
      try_CXXFLAGS_OPT="-w -ftemplate-depth-120 -O3"
      try_CXXFLAGS_DEBUG="-W -Wall -Wno-sign-compare -Wno-long-double -ftemplate-depth-120 -g -O0"
      try_CXXFLAGS_EH="-fexceptions"
      try_CXXFLAGS_NOEH="-fno-exceptions"
      ;;
    generic)
