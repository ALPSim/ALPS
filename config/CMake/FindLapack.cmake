...
IF(NOT LAPACK_LIBRARY_INIT)
  if(WIN32 AND NOT UNIX)
    set(TRIAL_PATHS "$ENV{HOMEDRIVE}/Program Files/clapack")
    find_library(LAPACK_LIBRARY lapack ${TRIAL_PATHS})
    find_library(BLAS_LIBRARY blas ${TRIAL_PATHS})
    find_library(F2C_LIBRARY f2c ${TRIAL_PATHS})
    mark_as_advanced(F2C_LIBRARY)
    if(LAPACK_LIBRARY AND BLAS_LIBRARY AND F2C_LIBRARY)
      SET(LAPACK_LIBRARY_INIT 1)
      SET(BLAS_LIBRARY_INIT 1)
      ...
      MESSAGE(STATUS "Found Lapack: ${LAPACK_LIBRARY} ${BLAS_LIBRARY} ${F2C_LIBRARY}")
    endif(LAPACK_LIBRARY AND BLAS_LIBRARY AND F2C_LIBRARY)
