AC_DEFUN([AC_BOOST],
  ...
  for d in $HOME $HOME/src $prefix $prefix/src /usr/local /usr/local/src; do
    for b in boost boost_1_42_0 boost_1_41_0 boost_1_40_0 boost_1_39_0 boost_1_38_0 boost_1_37_0 boost_1_36_0 boost_1_35_0 boost_1_34_1 boost_1_34_0 boost_1_33_1 boost_1_33_0 boost_1_32_0; do
...
#error
#endif],,ac_cv_boost_version=1_42)
  fi
  if test -z "$ac_cv_boost_version"; then
    AC_TRY_COMPILE([#include <boost/version.hpp>
...
#error
  ...
  AM_CONDITIONAL(BOOST_1_42, test "$ac_cv_boost_version" = 1_42)
