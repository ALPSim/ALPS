AC_DEFUN([AC_BOOST],
  ...
  for d in $HOME $HOME/src $prefix $prefix/src /usr/local /usr/local/src; do
    for b in boost boost_1_38_0 boost_1_37_0 boost_1_36_0 boost_1_35_0 boost_1_34_1 boost_1_34_0 boost_1_33_1 boost_1_33_0 boost_1_32_0; do
...
AC_DEFUN([AC_BOOST_LIBS],
  ...
  if test "$ac_cv_use_precompiled_boost" = yes; then
    ...
    if test "$ac_cv_boost_version" = svn || test "$ac_cv_boost_version" = 1_38 || test "$ac_cv_boost_version" = 1_37 || test "$ac_cv_boost_version" = 1_36 || test "$ac_cv_boost_version" = 1_35; then
      :;
    else
      ac_cv_boost_mpi=no
    fi
