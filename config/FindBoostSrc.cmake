...
if (NOT Boost_ROOT_DIR)
  if(BOOST_ROOT)
    ...
    set(DIR1 boost boostsrc boost_1_48_0 boost_1_47_0 boost_1_46_1 boost_1_46_0 boost_1_45_0 boost_1_44_0 boost_1_43_0)
...
if(Boost_ROOT_DIR)
  ...
  if(Boost_MAJOR_VERSION LESS 1 OR Boost_MINOR_VERSION LESS 43)
    message(FATAL_ERROR "Boost library is too old")
  endif(Boost_MAJOR_VERSION LESS 1 OR Boost_MINOR_VERSION LESS 43)
else(Boost_ROOT_DIR)
