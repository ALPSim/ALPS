...
#  SET(HDF5_LIBRARIES "" CACHE STRING "HDF5 libraries" FORCE)
  ...
  IF (WIN32 AND NOT UNIX)
    ...
    FIND_LIBRARY(HDF5_LIBRARIES hdf5dll ${VISTRAILS_APP_DIR}/${VISTRAILS_APP_NAME}/libsrc/hdf5-1.8.4-64bit-VS2008-IVF101/lib ${VISTRAILS_APP_DIR}/${VISTRAILS_APP_NAME}/libsrc/hdf5-1.8.4-32bit-VS2008-IVF101/dll NO_DEFAULT_PATH)  
    SET(HDF5_DLLS "${VISTRAILS_APP_DIR}/${VISTRAILS_APP_NAME}/libsrc/hdf5-1.8.4-32bit-VS2008-IVF101/dll/hdf5dll.dll")  
    SET(HDF5_FOUND TRUE)  
  ENDIF (WIN32 AND NOT UNIX)
  IF (APPLE)
