...
#  SET(HDF5_LIBRARIES "" CACHE STRING "HDF5 libraries" FORCE)
  ...
  IF (WIN32 AND NOT UNIX)
    FIND_PATH(HDF5_INCLUDE_DIR hdf5.h ${CMAKE_INSTALL_PREFIX}/${VISTRAILS_APP_NAME}/libsrc/hdf5-1.8.4-32bit-VS2008-IVF101/include NO_DEFAULT_PATH)
    FIND_LIBRARY(HDF5_LIBRARIES hdf5dll ${CMAKE_INSTALL_PREFIX}/${VISTRAILS_APP_NAME}/libsrc/hdf5-1.8.4-32bit-VS2008-IVF101/dll NO_DEFAULT_PATH)    
    SET(HDF5_FOUND TRUE)
  ENDIF (WIN32 AND NOT UNIX)
  IF (APPLE)
    FIND_PATH(HDF5_INCLUDE_DIR hdf5.h ${CMAKE_INSTALL_PREFIX}/${VISTRAILS_APP_NAME}/Contents/Resources/hdf5/include NO_DEFAULT_PATH)
    FIND_LIBRARY(HDF5_LIBRARIES hdf5 ${CMAKE_INSTALL_PREFIX}/${VISTRAILS_APP_NAME}/Contents/Resources/hdf5/lib NO_DEFAULT_PATH)
    SET(HDF5_FOUND TRUE)
  ENDIF (APPLE)
