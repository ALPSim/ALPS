...
if(not_successful)
    message(SEND_ERROR "error runing test 'ngs_ising_threaded': ${err}; shell output: ${not_successful}!")
...
file(REMOVE ngs_ising_threaded_output_1)
file(REMOVE ngs_ising_threaded_output_2)
