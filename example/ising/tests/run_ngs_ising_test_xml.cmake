...
execute_process(
    COMMAND ${mpiexec} ${mpiexec_numproc_flag} ${procs} ${cmd_path} -T 15 ${sourcedir}/params/param.task1.in.xml ${cmd}.result.h5 ${cmd}.checkpoint.h5
...
execute_process(
    COMMAND ${mpiexec} ${mpiexec_numproc_flag} ${procs} ${cmd_path} -T 15 --continue ${sourcedir}/params/param.task1.in.xml ${cmd}.result.h5 ${cmd}.checkpoint.h5
    RESULT_VARIABLE not_successful
