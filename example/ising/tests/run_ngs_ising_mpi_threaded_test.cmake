...
execute_process(
    COMMAND mpirun -n 4 ${cmd_path} -T 15 ${currentdir}/params/param.h5 sim.mpi_threaded
...
execute_process(
    COMMAND mpirun -n 4 ${cmd_path} -T 15 --continue ${currentdir}/params/param.h5 sim.mpi_threaded
    RESULT_VARIABLE not_successful
