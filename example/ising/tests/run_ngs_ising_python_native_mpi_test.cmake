...
file(WRITE run_ngs_ising_python_native_tmp.sh "PYTHONPATH=\$PYTHONPATH:${binarydir}/lib/pyalps:${binarydir}/src/boost:${sourcedir}/lib ${MPIEXEC} -n 2 ${python_interpreter} ${currentdir}/main_native.py 15 f sim.mpi.h5")
