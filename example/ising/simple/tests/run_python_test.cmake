...
file(WRITE ${cmd}_tmp.sh "PYTHONPATH=\$PYTHONPATH:${binarydir}/lib/pyalps:${binarydir}/src/boost:${sourcedir}/lib:${bindir}:${currentdir} ${runexec} ${python_interpreter} ${currentdir}/${cmd}.py 15 f ${cmd}.h5")
