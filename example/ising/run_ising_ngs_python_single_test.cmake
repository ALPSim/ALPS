...
file(WRITE run_ngs_ising_python_tmp.sh "PYTHONPATH=\$PYTHONPATH:${binarydir}/lib/pyalps:${binarydir}/src/boost:${sourcedir}/lib mpirun -n 2 python ${currentdir}/main_ising.py 15 f sim.ising.h5")
