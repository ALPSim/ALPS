...
namespace ietl {
    ...
    template <class SCALAR, unsigned int BICGSTAB_L, class VECTOR, class MATRIX>
    #else
    template <class SCALAR, unsigned int BICGSTAB_L = 2, class VECTOR, class MATRIX>
    #endif
    VECTOR ietl_bicgstabl ( const MATRIX& A,
                            const VECTOR& b,
                            const VECTOR& x0,
                            size_t maxiter = 100,
...
// wrapper //////////////////////////////////////////////////////////////////////////
    #ifndef __GXX_EXPERIMENTAL_CXX0X__
    template <class SCALAR, unsigned int BICGSTAB_L>
    #else
    template <class SCALAR, unsigned int BICGSTAB_L = 2>
    #endif
    class bicgstab_wrapper {
        public:
            ...
            template <class VECTOR, class MATRIX>
                ...
                {
                    return ietl_bicgstabl <SCALAR,BICGSTAB_L,VECTOR,MATRIX> ( A, b, x0, maxiter_, tol);
                }
        private:
            size_t maxiter_;
    };//wrapper
